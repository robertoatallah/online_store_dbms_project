                  ...
                  ?>
                    <tr>
                      ...
                      <td class="p-3 align-middle border-light">
                        <p class="mb-0 small"><?php echo $product['price']?></p>
                      </td>
                      <td class="p-3 align-middle border-light">
                        
                        <p class="mb-0 small"><?php echo $rows['quantity']?></p>
                        
                      </td>
                      <td class="p-3 align-middle border-light">
                      <?php $total =((intval($rows['quantity']) * intval($product['price'])));
                            $sum_total += $total;

                      ?>
                        <p class="mb-0 small"><?php echo $total . "$"?></p>
                      </td>
                      <form action="remove_from_cart.php" method = "POST">
                        <input type="hidden" name="id" value="<?php echo $carts_id ;?>">
                        <input type="hidden" name="products_id" value="<?php echo $products_id ;?>">
                        <td class="p-3 align-middle border-light"><button class="reset-anchor" type="submit"><i class="fas fa-trash-alt small text-muted"></i></button></td>
                      </form>
                    </tr>
                    <?php
                    }
              ...
              <div class="card border-0 rounded-0 p-lg-4 bg-light">
                <div class="card-body">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="d-flex align-items-center justify-content-between mb-4"><strong class="text-uppercase small font-weight-bold">Total</strong><span><?php echo $sum_total . '$' ?></span></li>
                    <li>
                      <?php $_SESSION['sum_total'] = $sum_total;?>
                    </li>
                  </ul>
                </div>
              </div>
