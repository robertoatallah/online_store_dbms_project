...
<html>
  <head>
    ...
    <title>La Boutique Beirut</title>
  ...
  <body>
    ...
    <div class="page-holder">
      ...
      <!-- HERO SECTION-->
      <div class="container">
        <section class="hero pb-3 bg-cover bg-center d-flex align-items-center" style="background: url(images/home2.jpg)">
          <div class="container py-5">
            <div class="row px-4 px-lg-5">
              <div class="col-lg-6">
                <p style="color: #dee0e0"  ></br></br></br></br></br></br></br></br>NEW SPRING 2022 COLLECTION</p>
                <h1 style="color: #dee0e0" class="h2 text-uppercase mb-3">20% off on new season</h1><a class="btn btn-dark" href="shop.php">Browse collections</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section class="pt-5">
          ...
          <div class="row">
            <div class="col-md-4"><a class="category-item" href="shop2.php"><img class="img-fluid" src="images/home3.jpg" alt=""/><strong class="category-item-title">T-shirts</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item mb-4" href="shop3.php"><img class="img-fluid" src="images/home4.jpg" alt=""/><strong class="category-item-title">Hoodies</strong></a>
            </div>
            <div class="col-md-4"><a class="category-item" href="shop4.php"><img class="img-fluid" src="images/home5.jpg" alt=""/><strong class="category-item-title">Sweatpants</strong></a>
            </div>
          </div>
        </section>
              ...
              <div class="col-lg-6">
                <form action="#">
                  <div class="input-group">
                    <input class="form-control form-control-lg" type="hidden" placeholder="Enter your email address" aria-describedby="button-addon2">
